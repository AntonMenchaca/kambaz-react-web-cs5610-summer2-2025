...
export default function Signup() {
  ...
  return (
    <div className="wd-signup-screen">
      <h1>Sign up</h1>
      <FormControl value={user.firstName || ''} onChange={(e) => setUser({ ...user, firstName: e.target.value })}
        className="wd-firstname mb-2" placeholder="First Name" />
      <FormControl value={user.lastName || ''} onChange={(e) => setUser({ ...user, lastName: e.target.value })}
        className="wd-lastname mb-2" placeholder="Last Name" />
